...
Input_parameters.H_TVC              = 0.4;   %assumptiOn from Raymer t6.4 
...
Input_parameters.n_passenger                = Input_parameters.n_passenger_per_row*Input_parameters.n_rows;
Input_parameters.max_takeoff_distance  = 100*.3048;   %100ft to m
Input_parameters.nmax                   = 2;
