% Originally called POLARCONT Polar contour plot
%
% Richard Rieber
%if you want 0 degree to be up and clockwise to be positive (wind and wave data for example) replace 
%line 47 and 48 by: 
...
function [C,h] = polar_contour_plot(r,theta,z,N,s)
